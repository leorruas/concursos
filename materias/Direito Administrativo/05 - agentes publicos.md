...
```mermaid
graph TD
    A[Agente Público] --> B[Agentes Políticos]
    A --> C[Agentes Administrativos]
    A --> D[Agentes Honoríficos]
    A --> E[Agentes Delegados]
    A --> F[Agentes Credenciados]
    
    style B fill:#e3f2fd,stroke:#1e88e5,stroke-width:1px
    style C fill:#fff3e0,stroke:#fb8c00,stroke-width:1px
    style D fill:#f1f8e9,stroke:#7cb342,stroke-width:1px
    style E fill:#f3e5f5,stroke:#8e24aa,stroke-width:1px
    style F fill:#eceff1,stroke:#546e7a,stroke-width:1px
```
