...
- **Erro comum:** assumir que a variável é a mesma em toda a frase, achando que o "x" repetido deixaria a frase aberta. Each quantificador define seu próprio escopo (universo).
